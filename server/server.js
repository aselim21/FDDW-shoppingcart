...
app.use((req, res, next) => {
    ...
    res.header('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept, Access-Control-Allow-Credentials, Cookie, Set-Cookie, Access-Control-Request-Method, Access-Control-Request-Headers');
